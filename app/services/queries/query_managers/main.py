...
def create_views():
    ...
    views = [
        'profitability_views.sql', 'cash_flow_views.sql',
        'liquidity_views.sql', 'assets_liabilities_views.sql'
    ]
    for view in views:
        query_manager.execute_sql_file(
            f'app/services/queries/sql_views/{view}')
