...
from app.gallery.components.elements.dashboard.setup import \
    DivergenceDashboardSetup

from .base import DashboardBase


class ProfitabilityDivergenceDashboard(DashboardBase):
    """
    ...
    Attributes:
        divergence_selected_metrics (List[str]): Metrics selected for the line chart visualization.
    """
    ...
    def setup_content(self) -> None:
        ...
        self.divergence_selected_metrics = self.ui.select_metrics(divergence_metrics,
                                                            key='divergence',
        ...
        self.initialize_dashboard_with_data(DivergenceDashboardSetup,
