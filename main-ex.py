...
def third_tier_main():
    ...
    if cik:
        ...
        if available_queries:
            query_type = st.sidebar.selectbox("Select Query Type", available_queries)
            ...
            if query_type:
                ...
                show_divergence_line = st.sidebar.checkbox('Show Divergence Line Chart')
                ...
                if dashboard_class:
                    ...
                    dashboard = dashboard_class(cik=cik, selected_widgets=selected_widgets)
                    dashboard.render_dashboard()
                else:
                    st.error("Dashboard not found for the selected query type.")
        else:
