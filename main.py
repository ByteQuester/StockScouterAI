    ...
    if selected_ciks and start_date and end_date:
        ...
        with tab2:
            ...
            FinancialChart("line", df_assets_liabilities, "Debt to Equity Ratio",
                           "DATE", "DEBT_TO_EQUITY_RATIO", "ENTITY").render()
        ...
        with tab3:
            ...
            x = FinancialChart("bar", df_cash_flow, "Cash Flow Summary", "DATE", [
                "CASH_FLOW_OPERATING", "CASH_FLOW_INVESTING", "CASH_FLOW_FINANCING"], "ENTITY"
            ).render(use_container_width=True)
        with tab4:
        ...
        with tab5:
            ...
            FinancialChart("line", df_liquidity, "Liquidity - Current Ratio Trend",
                           "DATE",
                           "CURRENT_RATIO", "ENTITY").render(use_container_width=True)
        st.divider()
